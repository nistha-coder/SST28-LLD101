...
public final class IncidentTicket {
    ...
    private IncidentTicket(builder b) {
        ...
        this.tags = new ArrayList<>(b.tags); // BROKEN: mutable
    ...
    private  String source;
        ...
        public builder setTags(List<String> tags) { this.tags =  new ArrayList<>(tags); return this; } // defensive copy
        ...
        public IncidentTicket build() {
            ...
            Validation.requireMaxLen(title, 80, "title");Validation.requireRange(slaMinutes, 5, 7200, "slaMinutes");
